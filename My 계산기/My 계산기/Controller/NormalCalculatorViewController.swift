...
extension NormalCalculatorViewController {
    ...
    func configureButtonUI() {
        ...
        for button in operationButtonCollection {
            ...
            button.backgroundColor = UIColor(red: 0.02,
                                             green: 0.42,
                                             blue: 0.91,
                                             alpha: 1.00)
            button.layer.cornerRadius = button.frame.width / 2
        ...
        for button in clearButtonCollection {
            ...
            button.backgroundColor = UIColor(red: 0.73,
                                             green: 0.73,
                                             blue: 0.73,
                                             alpha: 1.00)
            button.layer.cornerRadius = button.frame.width / 2
        ...
        let smallConfiguration = UIImage.SymbolConfiguration(pointSize: 50,
                                                             weight: .bold,
                                                             scale: .small)
        let smallSymbolImage = UIImage(systemName: "delete.left.fill",
                                       withConfiguration: smallConfiguration)
        clearButtonCollection[1].setImage(smallSymbolImage,
                                          for: .normal)

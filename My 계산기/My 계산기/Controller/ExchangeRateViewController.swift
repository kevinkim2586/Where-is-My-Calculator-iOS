...
extension ExchangeRateViewController: ExchangeRateManagerDelegate{
    ...
    func didUpdateExchangeRate(_ exchangeRateManager: ExchangeRateManager, exchange: ExchangeRateModel) {
        ...
        DispatchQueue.main.async {
            ...
            let formattedFinalResult = String(format: "%.1f",
                                              locale: Locale.current,
                                              Double(exchange.finalResult))
...
extension ExchangeRateViewController {
    ...
    func configureUIButton() {
        ...
        // Equal button
        let equalButtonImage = UIImage(systemName: "equal",
                                       withConfiguration: smallConfiguration)
        operationButtonCollection[0].setImage(equalButtonImage,
                                              for: .normal)
        ...
        operationButtonCollection[1].setImage(swapButtonImage,
                                              for: .normal)
        ...
        // Delete button
        let deleteButtonImage = UIImage(systemName: "delete.left.fill",
                                        withConfiguration: smallConfiguration)
        operationButtonCollection[3].setImage(deleteButtonImage,
                                              for: .normal)
    }
